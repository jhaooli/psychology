...
<div class="d-flex align-items-stretch">
    ...
    <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
            ...
            <li class="sidebar-list-item"><a href="/zixun-tables" class="sidebar-link text-muted active"><i class="o-table-content-1 mr-3 text-gray"></i><span>报表</span></a></li>
            ...
            <section class="py-5">
                <div class="row">
                    <div class="col-lg-6 mb-4">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="text-uppercase mb-0">待处理预约表</h6>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="text-uppercase mb-0">过往预约</h6>
                            </div>
                            <div class="card-body">
