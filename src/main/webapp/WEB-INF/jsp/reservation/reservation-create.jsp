            ...
            <div class="col-lg-12 mb-5">
                <div class="card">
                    <div class="card-header">
                        <h3 class="h6 text-uppercase mb-0">心理咨询预约</h3>
                    </div>
                    <div class="card-body">
                        <form class="form-horizontal" action="/reservation/createReservation" method="post">


                            <div class="form-group row">
                                <label class="col-md-3 form-control-label">提前告知（选填）</label>
                                <div class="col-md-9">
                                    <input  type="text" class="form-control" name="context"><small class="form-text text-muted ml-3">请说明你的现况。</small>
                                </div>
                            </div>
                            <div class="line"></div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label">请选择咨询师<br><small class="text-primary"></small></label>
                                <div class="col-md-9">

                                    <c:forEach items="${detailList}" var="item">

                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input id="customRadioInline1${item.usernamed}" type="radio"  name="memberName" class="custom-control-input" value="${item.usernamed}">
                                        <label for="customRadioInline1${item.usernamed}"  class="custom-control-label">${item.usernamed}</label>
                                    </div>
                                    </c:forEach>
