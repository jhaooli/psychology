...
<!-- navbar-->
<header class="header">
    <nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow"><a href="#" class="sidebar-toggler text-gray-500 mr-4 mr-lg-5 lead"><i class="fas fa-align-left"></i></a><a href="index.html" class="navbar-brand font-weight-bold text-uppercase text-base">活动管理</a>
            ...
            <div class="col-lg-12 mb-5">
                <div class="card">
                    <div class="card-header">
                        <h3 class="h6 text-uppercase mb-0">发布新活动</h3>
                    </div>
                    <div class="card-body">
                        <form class="form-horizontal" action="/activity/insertActivity" method="POST">


                            <div class="form-group row">
                                <label class="col-md-3 form-control-label">活动标题</label>
                                <div class="col-md-9">
                                    <input name="title" type="text" class="form-control"><small class="form-text text-muted ml-3">activity title</small>
                                </div>
                            </div>
                            <div class="line"></div>
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label">活动内容</label>
                                <div class="col-md-9">
                            ...
                            <div class="line"></div>
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label">请选择活动日期</label>
                                <div class="col-md-9">
